...
namespace ConferenceProject.Migrations
{
    public partial class prop : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropColumn(name: "_email", table: "AspNetUsers");
            migrationBuilder.DropColumn(name: "_isAdmin", table: "AspNetUsers");
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    _movie = table.Column<string>(nullable: true),
